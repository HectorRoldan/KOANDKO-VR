...
public class MainActivity extends AppCompatActivity {
    ...
    class VideoLoaderTask extends AsyncTask<Pair<Uri, VrVideoView.Options>, Void, Boolean> {
        ...
        protected Boolean doInBackground(Pair<Uri, VrVideoView.Options>... fileInformation) {
          ...
          /*videoWidgetView.loadVideo(
                  Uri.parse("http://192.168.100.107/hector/three/gyroscope/resources/Experience%20the%20Blue%20Angels%20in%20360-degree%20video.mp4"),
                  options);*/
                    //videoWidgetView.loadVideo();
                    videoWidgetView.loadVideo (Uri.parse("http://192.168.100.107/hector/three/gyroscope/resources/buyLaptop.MP4"),new VrVideoView.Options());
                } else {
